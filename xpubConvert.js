...
*/
exports.changeVersionBytes = function(xpub, targetFormat) {
  ...
  try {
    ...
    throw new Error(`Invalid extended public key! Please double check that you didn't accidentally paste extra data. ${err}`)
  }
}

exports.getFingerprint = function(xpub, targetFormat) {
  return byteArrayToHexString(bip32.fromBase58(changeVersionBytes(xpub, targetFormat), NETWORK_TYPES[targetFormat]).fingerprint);
}

exports.getParentFingerprint = function(xpub, targetFormat) {
  return bip32.fromBase58(changeVersionBytes(xpub, targetFormat), NETWORK_TYPES[targetFormat]).parentFingerprint.toString(16);
}

exports.getDepth = function(xpub, targetFormat) {
